...
CMD_CURRICULUM_STEP_SIZE = 500000  # Number of steps before each increment
...
class RobotPushEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: RobotSceneCfg = RobotSceneCfg(num_envs=4096, env_spacing=3.0) # distance (in meters) between neighboring environment origins in the world layout.
